...
Hace algún tiempo (largo), [escribía](https://varodonaire.soy/tech/LaTeX-parte-1/) sobre LaTeX y las aplicaciones, para mí deficientes, que hay en iOS para escribir en este formato. En resumen, nada que ver con la riqueza que hay para escribir en markdown, por ejemplo.
